        ...
        {items.map((item) => (
          <SwiperSlide key={item.id} className="w-auto">
            <Link href={`/news/${item.id}`} className="block">
              <div className="flex h-[93px] w-[300px] flex-col justify-center gap-3 rounded-lg border border-[#D4D7DC] bg-white px-4 py-3 shadow-[0_2px_6px_rgba(0,0,0,0.08),0_6px_16px_rgba(0,0,0,0.12)]">
